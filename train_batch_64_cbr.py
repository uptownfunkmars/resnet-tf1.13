...
parser.add_argument('--lr', type=float, default=0.00001, help='learning rate base')
...
def train():
    ...
    with tf.Session() as sess:
        # 断点继续训练
        saver.restore(sess, '/home/sdc/xujiping_sde/saved_model_cbr' + '/epoch_s1_9.ckpt')
        ...
        for epoch in range(epochs):
            ...
            for vi, vl in val_generator:
                ...
                va, summary = sess.run([accuracy, merged], {x: vi, y_true: vl, is_training: is_train})
            ...
            print("Saving model.....")
            if (epoch + 1) % 10 == 0 :
                saver.save(sess, model_saved_path + "/epoch_s2_%d.ckpt" % epoch)
